...
struct Color_Effects_Dynamic{
    ...
    static void color_lane(Panel &led_panel, unsigned int length = 1, unsigned int red = 255, unsigned int green = 255, unsigned int blue = 255, unsigned int white = 255, unsigned int vel
